...
$sum_total_income=$result6['totalincome'];
 ?>
					<div class="panel-body easypiechart-panel" style="background-color:#e6e6fa;">
						<h4>Total balance</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $sum_total_income-$sum_total_expense;?>" ><span class="percent"><?php if($sum_total_income-$sum_total_expense==""){
echo "0";
} else {
